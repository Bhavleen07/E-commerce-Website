            ...
            <div className="p-4 md:w-1/3 sm:w-1/2 w-full">
              ...
              >
                ...
                <p
                  ...
                  style={{ color: mode === "dark" ? "white" : "#6B7280" }}
                >
                  Beautifully crafted gifts made with love & care.
                </p>
              </div>
            </div>
            ...
            <div className="p-4 md:w-1/3 sm:w-1/2 w-full">
              ...
              >
                ...
                <p
                  ...
                  style={{ color: mode === "dark" ? "white" : "#6B7280" }}
                >
                  We deliver handmade treasures all across India.
                </p>
              </div>
            </div>
            ...
            <div className="p-4 md:w-1/3 sm:w-1/2 w-full">
              ...
              >
                ...
                <p
                  ...
                  style={{ color: mode === "dark" ? "white" : "#6B7280" }}
                >
                  Create personalized hampers for every special occasion.
                </p>
              </div>
            </div>
          </div>
