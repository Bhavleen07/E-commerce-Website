...
export default function Navbar() {
  ...
  const email = user?.email || user?.user?.email; // unified email check
            ...
            >
              ...
              >
                ...
                <div className="space-y-6 border-t border-gray-200 px-4 py-6">
                  {/* Show links only if NOT admin */}
                  {email !== "kaurkraftshop@gmail.com" && (
                    <>
                      <Link
                        to={"/allproducts"}
            ...
            <div className="flex h-16 items-center">
              ...
              <div className="ml-4 flex lg:ml-0">
                <Link to={"/"} className="flex">
                  <div className="flex">
                    <h1
                      className="text-4xl font-cratejoy text-black px-2 py-1 rounded"
                      style={{ color: mode === "dark" ? "white" : "" }}
                    >
                      Kaurkrafts
                    </h1>
              ...
              <div className="ml-auto flex items-center">
                ...
                <div className="hidden lg:ml-8 lg:flex">
                  <a href="#" className="flex items-center text-gray-700 ">
                    ...
                    />
                    <span
                      className="ml-3 block text-15px font-medium"
                      style={{ color: mode === "dark" ? "white" : "" }}
                    >
                      INDIA
                    </span>
